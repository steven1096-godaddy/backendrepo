...
# Configure CORS
origins = [
    "http://localhost",  # Add your allowed origin(s) here
]
...
app.add_middleware(
    ...
    allow_methods=["*"],  # You can specify HTTP methods or use ["*"] to allow all
    allow_headers=["*"],  # You can specify headers or use ["*"] to allow all
)
